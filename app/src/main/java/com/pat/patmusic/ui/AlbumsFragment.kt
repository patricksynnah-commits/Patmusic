...
import com.pat.patmusic.adapter.AlbumAdapter
import com.pat.patmusic.databinding.FragmentAlbumsBinding
...
class AlbumsFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        albumAdapter = AlbumAdapter { albumName, songs ->
        ...
        viewModel.songs.observe(viewLifecycleOwner) { _ ->
            val albums = viewModel.getSongsByAlbum()
